...
import Nav from "@/components/NavMobile";
...
const Home = () => {
  const { tasks, fetchData, handleDelete, isModalOpen, setIsModalOpen, mobileMenu, handleComplete } = useContext(DataContext);
  ...
  return (
    <div className="min-h-screen w-full flex p-4 bg-slate-200">
      {/* MODAL */}
      <Modal isVisible={isModalOpen} onClose={() => setIsModalOpen(false)} />
      {/* NAV */}
      <Nav />
      {/* INDEX */}
      <ul className="flex flex-col gap-6 ml-12">
